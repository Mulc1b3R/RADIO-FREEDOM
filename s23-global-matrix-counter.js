        ...
        const scanPromises = DATABASE_ROSTER.map(fileUrl => 
            fetch(fileUrl)
                ...
                .then(data => {
                    ...
                    absoluteTotalTracks += entriesCount;
                })
                .catch(err => {
                    // Silent fail safety: If a specific show JSON isn't deployed yet, skip it gracefully
